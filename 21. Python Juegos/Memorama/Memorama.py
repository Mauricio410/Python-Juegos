...
cuadros = [
    [Cuadro("imagenes/baloncesto.png"), Cuadro("imagenes/baloncesto.png"),
     Cuadro("imagenes/beisbol.png"), Cuadro("imagenes/beisbol.png")],
    [Cuadro("imagenes/bicicleta.png"), Cuadro("imagenes/bicicleta.png"),
     Cuadro("imagenes/bolos.png"), Cuadro("imagenes/bolos.png")],
    [Cuadro("imagenes/boxeo.png"), Cuadro("imagenes/boxeo.png"),
     Cuadro("imagenes/futbol-americano.png"), Cuadro("imagenes/futbol-americano.png")],
    [Cuadro("imagenes/ping-pong.png"), Cuadro("imagenes/ping-pong.png"),
     Cuadro("imagenes/futbol.png"), Cuadro("imagenes/futbol.png")],
]
...
# Sonidos
sonido_fondo = pygame.mixer.Sound("audio/fondo.wav")
sonido_click = pygame.mixer.Sound("audio/clic.wav")
sonido_exito = pygame.mixer.Sound("audio/ganador.wav")
sonido_fracaso = pygame.mixer.Sound("audio/equivocado.wav")
sonido_voltear = pygame.mixer.Sound("audio/voltear.wav")
